...
"Breast Cancer mini-project using SVM" was a complementary work using the same dataset in "Coding_logistic_regression_assignment" with some modifications, which are: 1- splitting the data into training, testing, and validation data instead of only training and testing data. 2- using Support Vector Mechanics (SVM) with different values of constant 'C' in our logestic regression model.
